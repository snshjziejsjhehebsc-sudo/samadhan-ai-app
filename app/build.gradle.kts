...
System.getenv().forEach { (k, v) ->
  if (k.endsWith("_API_KEY") || k.startsWith("HUGGINGFACE_") || k.startsWith("GEMINI_") || k.startsWith("POLLINATIONS_")) {
    envProps.setProperty(k, v)
  }
}
if (!envProps.isEmpty()) {
  FileOutputStream(envFile).use { envProps.store(it, "Environment Secrets") }
}
